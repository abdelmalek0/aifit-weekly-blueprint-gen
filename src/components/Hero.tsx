...
import { ArrowRight, Play, Target, Clock, Zap } from "lucide-react";
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        ...
        {/* Main headline */}
        <h1 className="text-5xl md:text-7xl font-bold font-poppins mb-6 animate-fade-in" style={{animationDelay: '0.2s'}}>
          Your Personal
          <br />
        ...
        {/* Subtitle */}
        <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto animate-fade-in" style={{animationDelay: '0.4s'}}>
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-10 animate-fade-in" style={{animationDelay: '0.6s'}}>
          ...
          <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2">
            ...
            <span>YouTube Workouts</span>
          </div>
        </div>

        {/* CTA buttons */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{animationDelay: '0.8s'}}>
          <Button size="lg" className="bg-white text-fitness-primary hover:bg-white/90 font-semibold px-8 py-4 text-lg rounded-full transition-all duration-300 hover:scale-105">
            Generate My Plan
            <ArrowRight className="ml-2 w-5 h-5" />
          </Button>
          <Button size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10 font-semibold px-8 py-4 text-lg rounded-full backdrop-blur-sm">
            See How It Works
        ...
        <div className="mt-16 animate-fade-in" style={{animationDelay: '1s'}}>
          <p className="text-white/70 mb-4">Trusted by fitness enthusiasts worldwide</p>
